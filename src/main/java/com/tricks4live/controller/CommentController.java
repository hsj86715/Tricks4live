...
public class CommentController {
    ...
    @RequestMapping("/findHottest")
    public DataResult<List<CommentInfo>> findHottest(@RequestParam("subject_id") Long subjectId,
                                                     @RequestParam(name = "size", required = false, defaultValue = "5") Integer size) {
        DataResult<List<CommentInfo>> result = new DataResult<>();
        result.setData(service.findHottest(subjectId, size));
        return result;
    }
